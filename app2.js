...
const addTextWatermarkToImage = async function(inputFile, outputFile, text) {
  try {
    ...
    console.log('error: ', error.message); // if there's an error, we catch it and show it in console
  }
};
...
const addImageWatermarkToImage = async function(inputFile, outputFile, watermarkFile) {
  ...
  try {
    ...
    console.log('error: ', error); // if there's an error, we catch it and show it in console
  }
};
